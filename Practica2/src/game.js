...
var playGame = function() {
  var boardFondo = new GameBoard();
  var board = new GameBoard();
  //board.add(new PlayerShip());
  board.add(new PlayerFrogg());
...
PlayerFrogg.prototype = new Sprite();
PlayerFrogg.prototype.type = OBJECT_PLAYER;

PlayerFrogg.prototype.hit = function(damage) {
